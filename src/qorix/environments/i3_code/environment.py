...
from qorix.environments.base import EvalMetricsResult, Sample, RewardResult, SingleTurnEnvironment
from qorix.environments.parsers import strip_think_tags
from qorix.environments._sandbox import (
    GenericSandboxPool,
    SandboxConfig,
    SandboxError,
...
class I3CodeEnvironment(SingleTurnEnvironment):
    ...
    metrics_ranges = {
        ...
        "sandbox_error": {"min": 0, "max": 1, "invert": True},
        "num_test_cases": {"min": 0, "max": 15},
        "num_timeouts": {"min": 0, "max": 15, "invert": True},
        "num_errors": {"min": 0, "max": 15, "invert": True},
        "retry_count": {"min": 0, "max": 3, "invert": True},
        "failed_attempts_time": {"min": 0, "max": 600, "invert": True},
        # Timing metrics (seconds)
        "ops_semaphore_wait_time": {"min": 0, "max": 60, "invert": True},
        "sandbox_acquire_time": {"min": 0, "max": 600, "invert": True},
        "test_time": {"min": 0, "max": 300, "invert": True},
        "bundle_build_time": {"min": 0, "max": 30, "invert": True},
        "upload_semaphore_wait_time": {"min": 0, "max": 60, "invert": True},
        "bundle_upload_time": {"min": 0, "max": 60, "invert": True},
        "bundle_extract_time": {"min": 0, "max": 60, "invert": True},
        "bundle_total_time": {"min": 0, "max": 120, "invert": True},
        "tests_execution_time": {"min": 0, "max": 300, "invert": True},
        "slowest_test_time": {"min": 0, "max": 30, "invert": True},
        "fastest_test_time": {"min": 0, "max": 30, "invert": True},
        "median_test_time": {"min": 0, "max": 30, "invert": True},
        "total_reward_time": {"min": 0, "max": 600, "invert": True},
        # Code metrics
