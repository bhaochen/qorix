...
from qorix.utils.tlog.logger import drain_all_log_buffers, LogRecord
from qorix.orchestrator.loggers.system_metrics_logger import (
    SystemMetricsLogger,
    GpuMetricSample,
    CpuMetricSample,
)
from qorix.orchestrator.loggers.vllm_metrics_logger import (
    VllmMetricsLogger,
    VllmMetricSample,
)
from qorix.orchestrator.loggers.thread_pool_metrics_logger import (
...
class EventLogger:
    ...
    def _do_upload_sync(self):
        ...
        from qorix.utils import config as _config_mod
