...
also participate in parameter sharding.  Ring attention is enabled via
``ring-flash-attn`` which monkey-patches HuggingFace flash attention kernels.
"""
...
from qorix.trainer.context_parallel import setup_cp_params, shard_for_cp
