"""Pydantic schema for Qorix configuration.
...
class QorixConfig(BaseModel, extra="forbid"):
    ...
    def _check_tis_ppo_clip_conflict(self) -> QorixConfig:
    ...
    @model_validator(mode="after")
    def _check_ppo_clip_algo_conflict(self) -> QorixConfig:
    ...
    @model_validator(mode="after")
    def _check_clip_ratio_c(self) -> QorixConfig:
    ...
    @model_validator(mode="after")
    def _check_advantage_norm_algo_conflict(self) -> QorixConfig:
    ...
    @model_validator(mode="after")
    def _check_worker_tp_divisibility(self) -> QorixConfig:
    ...
    @model_validator(mode="after")
    def _check_fsdp_cp(self) -> QorixConfig:
