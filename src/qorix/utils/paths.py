"""
Centralized path management for qorix.
...
# Base directories
QORIX_ROOT = Path(__file__).resolve().parents[1]  # …/qorix
RUN_DIR = Path(os.environ.get("QORIX_RUN_DIR", os.getcwd())).resolve()
_ckpt_env = os.environ.get("QORIX_CHECKPOINT_DIR")
